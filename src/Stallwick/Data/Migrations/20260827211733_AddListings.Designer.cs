...
namespace Stallwick.Migrations
{
    ...
    [Migration("20260827211733_AddListings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stallwick.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Stallwick.Data.Listing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Stallwick.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Stallwick.Data.Listing", b =>
                {
                    b.HasOne("Stallwick.Data.ApplicationUser", "Seller")
                        .WithMany()
